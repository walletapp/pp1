...
class SMTP
{
    ...
    protected function edebug($str, $level = 0)
    {
        ...
        if (!in_array($this->Debugoutput, ['personal_log', 'angajatori_log', 'error_log', 'html', 'echo']) and is_callable($this->Debugoutput)) {
        ...
        switch ($this->Debugoutput) {
            case 'personal_log':
                ...
                file_put_contents('logs/personal_email_log.txt', $message.PHP_EOL , FILE_APPEND | LOCK_EX);
                break;
            case 'angajatori_log':
                //Don't output, just log
                $message = date("Y-m-d h:i:s").' - '.$str;
                file_put_contents('logs/angajatori_email_log.txt', $message.PHP_EOL , FILE_APPEND | LOCK_EX);
                break;
            case 'error_log':
                //Don't output, just log
                error_log($str);
